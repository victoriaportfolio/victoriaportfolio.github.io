          ...
          achievementGroups: [
            {
              ...
              items: [
                ...
                },
                {
                  tag: "ГРЕЙДЫ",
                  value: "3 грейда",
                  desc: "Карта компетенций с 12 критериями оценки и планами развития",
                },
                {
                  tag: "БЮДЖЕТ",
                  value: "500 тыс. ₽/год",
                  desc: "Исследования и инструменты: Maze, Miro, Figma",
                },
              ],
            },
            {
              ...
              items: [
                {
                  tag: "РЕДИЗАЙН",
                  value: "Полный редизайн",
                  desc: "Глубинные интервью, CJM, юзабилити-тестирование → новая ИА и визуальный стиль",
                },
                {
                  tag: "КОНВЕРСИЯ",
                  tagRight: "DAU",
                  value: "Рост метрик",
                  desc: "Конверсия в подписку, снижение bounce rate, рост DAU",
                },
                {
                  tag: "ПРОЦЕССЫ",
                  value: "RACI + Jira",
                  desc: "Дизайн-ревью, приоритизация, чеклисты, 1:1, трекинг KPI",
                },
              ],
            },
          ],
