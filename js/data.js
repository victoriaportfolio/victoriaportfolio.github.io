...
const SITE_DATA = {
  ...
  // Образование — вертикальный таймлайн под блоком «Опыт»
  education: [
    {
      degree: "РГСУ — магистр дизайна",
      institution: "Российский Государственный Социальный Университет",
      years: "2016–2019",
    },
    {
  ...
  experience: [
    ...
    },
    {
      ...
      companies: [
        ...
        {
          logoText: "МИНПРОСВЕЩЕНИЯ",
          name: "Министерство просвещения РФ → Сбербанк Технологии",
          logoSrc: "assets/logos/minprosv.png",
          whatIDid: [
            {
              title: "Единственный дизайнер продуктовой команды",
              text: "Начинала как единственный дизайнер продуктовой команды в Министерстве просвещения РФ, затем перешла с этой же командой в Сбербанк Технологии для масштабирования продукта.",
            },
            {
              title: "Образовательный портал «Растим детей»",
              text: "Спроектировала образовательный портал «Растим детей» для детей и родителей (Министерство просвещения).",
            },
            {
              title: "Внутренние B2B-продукты",
              text: "Спроектировала внутренние B2B-продукты для сотрудников министерства.",
            },
            {
              title: "Школьная цифровая платформа",
              text: "Спроектировала сайт школьной цифровой платформы в составе команды дизайнеров (Сбербанк Технологии) — государственный образовательный продукт с аудиторией 10+ млн пользователей.",
            },
          ],
          achievementGroups: [
            {
              ...
              items: [
                {
                  tag: "МИНПРОСВЕЩЕНИЯ",
                  value: "«Растим детей»",
                  desc: "Образовательный портал для детей и родителей",
                },
                {
                  tag: "МИНПРОСВЕЩЕНИЯ",
                  value: "B2B-платформы",
                  desc: "Внутренние продукты для сотрудников министерства",
                },
                {
                  tag: "СБЕРБАНК ТЕХНОЛОГИИ",
                  value: "10+ млн пользователей",
                  desc: "Школьная цифровая платформа — государственный образовательный продукт",
                },
              ],
            },
            {
              ...
              items: [
                {
                  ...
                  desc: "Jira, Miro — совместная работа с командой и разработкой",
                },
              ],
            },
          ],
      ...
      companies: [
        {
          ...
          whatIDid: [
            {
              title: "Full-time с совмещением обучения",
              text: "Full-time, совмещала с обучением в магистратуре. Компания реализовывала проекты для заказчиков из США — вела полный цикл дизайна: брендинг, упаковка, B2B SaaS-платформы.",
            },
            {
              title: "Клиентские проекты",
              text: "Участвовала в разработке сайтов и веб-платформ для клиентских проектов: Hampton, Berkshire, Эватор, Формула 360 (в паре с коллегой-дизайнером).",
            },
            {
              title: "Полный цикл дизайна",
              text: "Работала над полным циклом дизайна — от брендинга и упаковки продукта до интерфейсов B2B SaaS-платформ.",
            },
          ],
          achievementGroups: [
            {
              ...
              items: [
                { tag: "ПРОЕКТ", value: "Hampton", desc: "Сайт и веб-платформа" },
                { tag: "ПРОЕКТ", value: "Berkshire", desc: "Сайт и веб-платформа" },
                { tag: "ПРОЕКТ", value: "Эватор", desc: "Сайт и веб-платформа" },
                { tag: "ПРОЕКТ", value: "Формула 360", desc: "Сайт и веб-платформа" },
              ],
            },
            {
              label: "ПОДХОД",
              items: [
                {
                  tag: "ПОЛНЫЙ ЦИКЛ",
                  value: "Брендинг → B2B SaaS",
                  desc: "От брендинга и упаковки продукта до интерфейсов B2B SaaS-платформ",
                },
              ],
            },
          ],
